...
in_cv_file = db + "_" + st + "_"+ temp_feat + "_data_cv_expr_4ML_" + target + ".tsv"
in_test_file = db + "_" + st + "_" + temp_feat + "_data_test_expr_4ML_" + target + ".tsv"
output_file = db + "_" + st + "_" + temp_feat + "_results_nestedCV_" + target + ".csv"
out_test_file = db + "_" + st + "_" + temp_feat + "_results_test_" + model_name + "_" + target + ".csv"
out_ft_file = db + "_" + st + "_" + temp_feat + "_top_features_shap_" + target + ".csv"
out_shap_plot = db + "_" + st + "_" + temp_feat + "_shap_plot_" + target + ".pdf"
