...
# parse cmd arguments
parser = argparse.ArgumentParser(prog = 'PD_control_train.py',
                                 description = 'Nested CV at gene level')
...
target = "DIAGNOSIS"
input_file = temp_feature + "_data_cv_expr_4ML_" + target + ".tsv"
output_file = temp_feature + "_results_nestedCV_" + target + ".csv"
